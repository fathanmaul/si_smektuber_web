        ...
        <div class="container py-5">
            <div class="row g-5 d-flex justify-content-center align-items-center">
                <div class="col-lg-6 text-center">
                    <h1 class="display-4 mb-3 animated slideInDown">Judul Ekstra</h1>
            ...
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 wow fadeInUp order-lg-first" data-wow-delay="0.5s">
                    <div class="h-100">
                        ...
                        <h1 class="display-5">Judul Ekstra</h1>

                        <p>
                            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ut vel odio ex maiores reprehenderit
                            nesciunt repellat perferendis, in unde maxime pariatur, laudantium sapiente iste ducimus eius
                            reiciendis libero ad doloremque!
                        </p>
                        <br>
                    </div>
                </div>
    ...
    <div class="container-fluid pt-5">
        <div class="container">
            <div class="text-center pb-2">
                ...
                <h1 class="mb-4">Fasilitas Ekstrakulikuler</h1>
            </div>
