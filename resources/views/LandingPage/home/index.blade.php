        ...
        <div class="row g-5 align-items-center">
          ...
          <div class="col-lg-6 animated fadeIn">
            <img
              ...
              src="landing/img/logo_smektuber_hero.png"
              alt=""
            />
          </div>
        </div>
      ...
      <div class="container">
        <div class="row g-5 align-items-center">
          <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
            <img class="img-fluid" src="landing/img/smk7.png" alt="" />
          </div>
      ...
      <div class="container py-5">
        <div class="row g-5">
          <div
            ...
            data-wow-delay="0.1s"
          >
            <img class="img-fluid mb-4" src="landing/img/icon-9.png" alt="" />
            <h1 class="display-4" data-toggle="counter-up">123456</h1>
            <p class="fs-5 text-primary mb-0">Totak Jurusan</p>
          </div>
          <div
            class="col-lg-4 col-md-6 text-center wow fadeIn"
            data-wow-delay="0.3s"
          >
            <img class="img-fluid mb-4" src="landing/img/icon-10.png" alt="" />
            <h1 class="display-4" data-toggle="counter-up">123456</h1>
            <p class="fs-5 text-primary mb-0">Total Ekstarkurikuler</p>
          </div>
          <div
            class="col-lg-4 col-md-6 text-center wow fadeIn"
            data-wow-delay="0.5s"
          >
            <img class="img-fluid mb-4" src="landing/img/icon-2.png" alt="" />
            <h1 class="display-4" data-toggle="counter-up">123456</h1>
